...
print(num[1][0])
print(num[2][0])
for i in range(len(num)): #for i in range(3)이랑 같은 말
    print(num[i][0])
    
# 해보기
con = ['미국','영국','일본','중국','스페인'] #01234 5개
lang = ['영어','영어','일본어','중국어','스페인어'] #01234 5개

# 각각의 리스트에 프랑스, 프랑스어를 추가해보세요
# for문을 사용해서 다음과 같이 출력해보세요
# 미국은 영어를 사용합니다. ... 프랑스어는 프랑스어를 사용합니다
con.append('프랑스')
lang.append('프랑스어')

for i in range (len(con)): #len(con) 5개, lend(lang) 5개
