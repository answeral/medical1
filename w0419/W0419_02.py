...
#print(soup)
#----------------------------------------------------------------순위
num = soup.find("p",{"class":"no1"})
print(num.text)

best_div = soup.find("div",{"class":"best-list"})
li01=best_div.find("li")
print("li01 : ",li01.p.text)

#-----------------------------------------제목
title = soup.find("a",{"class":"itemname"})
print(title.text)

print("제목 : ",li01.find("a",{"class":"itemname"}).text)

#----------------------------------------------금액
# price = soup.find("div",{"class":"s-price"}.strong.span.text)
# print(price)
# spans = price.next("span")
