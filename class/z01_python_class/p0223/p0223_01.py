# 출력 print()
print("문자열") #실행 ctrl + f5 #문자열 출력
print(10.313) # 숫자 출력
print(123*212) # 사칙연산 후 출력

# %d 정수 %f 실수 %s 문자열을 나타낸다
print("%d %f %s"%(10,12.123,'문자'))
print("%.2f"%(22.4444456)) #소수 둘째자리까지 출력
...
print("{}".format(123))
# 실수
print("{0:f}".format(123.23456))
print('{0}'.format(123.456789))
print('{}'.format(123,456789))
print('{0:.2f}'.format(123.45678))
print('{:.2f}'.format(123.45678))
#문자
print("{0.s}".format("answer"))
print("{}".format("answer"))
...
#논리연산자
# and (둘이 참이어야 함)or (둘중에 하나만 참이어도 참) 
# not (참이면 거짓, 거짓이면 참)
a,b,c = 100,200,150
