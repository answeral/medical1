...
# stock = tr_list[2] # 3번째 존재하니, 2번째방. type : list (= element.ResultSet)
# td_list = stock.find_all("td")
# print('순위:',td_list[0].text)
# print('종목:',td_list[1].find("a").text)
# print('검색비율:',td_list[2].text)
# print('현재가:',td_list[3].text)
# # 1-5등까지, 종목, 검색비율, 현재가, PER ,ROE
# hanhwa = tr_list[3]
# td1_list = hanhwa.find_all("td")
# print('순위:',td1_list[0].text)
# print('종목:',td1_list[1].find("a").text)
# print("검색비율:",td1_list[2].text)
# print('현재가:',td1_list[3].text)
# print('PER:',td1_list[10].text)
# print('ROE:',td1_list[11].text)
# for i in range(2,7):
