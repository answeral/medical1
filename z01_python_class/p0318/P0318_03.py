class Car: # 명사는 변수, 동사는 함수로 구현
     ...
     # 생성자  # 위에 있는 변수와 다른 변수임, car_name='',color=''->키워드 매개변수
     def __init__(self,car_name='',color='',door=5,length=2000,width=1000,speed=0):
...
c4.length = 2000
c4.width = 1000
print('기본성능 : ',c4.car_name,c4.color,c4.door,c4.length,c4.width)
