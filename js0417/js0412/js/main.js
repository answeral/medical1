$(function(){
    ...
    let o_math =0;
        ...
        //최초 데이터 불러오기
        $.ajax({
            url:"http://127.0.0.1:5500/medical1-1/js0417/json/stu_score.json",
            type:"get",
            data:"",
            dataType:"json",
            success:function(data){
               ...
               s_count=data.length;
                ...
                let htmlData = "";
                    for (let i=0;i<10;i++){
                        htmlData += "<tr id='"+data[i].number+"'>";
                        htmlData += "<td><input type='checkbox' name='stu' class='stuChk' value='"+data[i].number+"'></td>";
                        htmlData += "<td>"+data[i].number+"</td>";
    ...
    // 최초실행 -------------------------------- 
        ...
        $("#searchBtn").click(function(){
            if($("#s_word").val().length<1){ //input이라서 val()
        ...
        $("#confirmBtn").on("click",function(){
            ...
            //번호생성은 DB에서 자동으로 부여
            //let i_no = Math.max.apply(null,number)+1;
            //no.push(i_number);
            ...
            htmlData += "<td><input type='checkbox' name='stu' class='stuChk' value='"+i_number+"'></td>";
            htmlData += "<td>"+i_number+"</td>";
            ...
            }else{ //학생성적수정창인 경우 - id value 값이 있는 경우
                alert("학생성적 수정창 클릭");
                o_no = $("#id").val();
                o_name = $("#name").val();
